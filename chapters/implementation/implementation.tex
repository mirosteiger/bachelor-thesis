...
Für die Darstellung durch Volume Ray Marching werden richtige Volumendaten, bzw. 3D-Texturen benötigt. Diese werden aus derselben Simulation erzeugt, die auch für die Lightmaps verwendet wird.
Es wird ein Ray Marching Shader implementiert, der eine 3D-Textur innerhalb der Geometrie darstellen kann, auf die dieser Shader angewendet wird. 
Für das Feuer ergibt es 
Es gibt zwei Möglichkeiten des Rauch zu 
