...
\usepackage[style=ext-authoryear, backend=biber, maxnames=1, maxbibnames=99]{biblatex}
\makeatletter
\def\blx@maxline{77}
\makeatother
...
\begin{titlepage}
	\begin{flushleft}
		\includegraphics[width=\textwidth]{Grafiken/TH.png}\\
		\vspace*{2cm}
	\end{flushleft}
...
\begin{figure}[b]
	\begin{flushright}
		\includegraphics[scale=1]{Grafiken/TH_LOGO}\\
	\end{flushright}
\end{figure}
